 ...
 */
public class BigClockDemo extends Thread {
    ...
    private BigClockDemo(String host, int port) throws LCDException {
        // Connect to LCDd
    ...
    public static void main(String args[]) throws Exception {
        ...
        final BigClockDemo clock = new BigClockDemo(host, port);
        clock.start();
